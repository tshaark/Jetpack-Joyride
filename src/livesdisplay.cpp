...
Livesdisplay::Livesdisplay(float x, float y, color_t color) {
...
void Livesdisplay::draw(glm::mat4 VP,int num) {
...
void Livesdisplay::set_position(float x, float y) {
    this->position = glm::vec3(x, y, 0);
}

void Livesdisplay::tick() {
}
